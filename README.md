...
### Особенности накопителей, выполненных по технологии SMR
...
Надёжность у современных дисков так себе, особенно если речь идёт про хранилище важных данных, поэтому следует периодически проверять их состояние. Кроме того, рекомендуется сделать проверку сразу после покупки накопителя, особенно если ты таки решил взять HDD с рук. Для этого в интернете можно найти массу утилит, самые ходовые из них `smartctl` и его графическая оболочка `gsmartcontrol`, `Victoria`, `CrystalDiskInfo`. Как производить оценку состояния - написано ниже, особо дотошные могут ознакомиться с не слишком свежим [статистическим исследованием](https://static.googleusercontent.com/media/research.google.com/ru//archive/disk_failures.pdf), посвященным оценке надежности накопителей в зависимости от ряда критериев, в том числе и рабочей температуры.
...
- **С2 - Temperature** - температура накопителя, собственно. Как правило, сам регистр показывает погоду на Марсе, но любой софт это дело парсит и выводит значение температуры отдельно. Вряд ли у тебя дома температуры ниже минимально комфортной для человека без шубы, посему главная задача - не перегревать накопитель. Оптимальная температура - 35-40 градусов, но и от 30 градусов никто не умрёт, а вот циклический прогрев накопителя до 50 градусов может негативно сказаться на его самочувствии. **При черезчур низких и даже отрицательных температурах шанс диска выйти из строя стремительно возрастает!**, смотри исследование.
...
Тебе говорили, что с рук брать не стоит? Ладно, забыли. Общий принцип при покупке винта заключается в следующем:
- HDD это весьма нежное устройство. Продаван может говорить что угодно, тебе главное понимать то, что вероятность получения в руки дохлого винта - __50%__. Часто на вторичку выкладывают накопители после падений - пока они не обновили статистику; диски с гуляющими проблемами чтения/записи могут себя никак не проявлять;
- На авите могут продаваться новые диски. А могут продаваться и не новые, аккуратно запакованные в антистатик под завод - это не повод думать, что тебе продают новый винт за шапку сухарей;
- продаваемые на вторичке диски условно можно разбить на несколько категорий: раритеты для ценителей <1Гб, хлам для некросборки <40Гб, барахло, на которое еле влезет одна современная игра <160Гб, снятые диски просто потому что места не хватает <750Гб, отработавшие в стойках/видеонаблюдении непонятно сколько времени <2Тб (тут кончается граница "проще выкинуть чем наебать"), предыдущий пункт + перепуки <6Тб, спиздил_с_серверной_эдишн всё остальное;
- Некоторые линейки дисков - seagate 7200.11 (муха CC) вплоть до **И** включая всю DM линейку, SMR накопители, WD EARS (тихо мрут на полке) и отработавшие достаточно много времени (15+ часов) 7200RPM диски - крайне рекомендуется обходить стороной. По 5400RPM - не стоит рассчитывать на их безотказную работу свыше 50к часов, по хорошему уже на диск с наработкой 20к часов не стоит возлагать больших надежд;
- Диски с наработкой менее 5к часов фактически ещё не прошли первичную обкатку - это диапазон сроков выхода из строя бракованных экземпляров;
- Да, диски с наработкой в пределах 7-20к часов имеют наибольший шанс обладать проблемами после нарушения условий эксплуатации;
- Да, SMART ряда дисков может быть подделан/сброшен прошаренным васяном: уже упомянутые Seagate (вплоть до 2013го года выпуска - поставили защиту на терминал) [тык](https://forum.ru-board.com/topic.cgi?forum=84&topic=5470#1). Кроме этого есть возможность нарваться на WD с копанной служебкой - до примерно того же года и если васян СИЛЬНО прошарен [тык](https://forum.ru-board.com/topic.cgi?forum=84&topic=5294) см. WDMarvel 2.3, WDR 6. Ковыряние HGST и современных Toshiba рядовой васян не осилит [тык](https://forum.ru-board.com/topic.cgi?forum=84&topic=5432#1);
- Для всего остального требуется аппаратный комплекс PC3000 который сам по себе стоит нехилых денег, а получить групповой привет в глаз за партию гнилых дисков не захочет ни один адекватный ремонтник/перепродаван; 
...
- Профиль продавана должен выглядеть убедительно: есть продажи с хорошими отзывами на протяжении хотя бы последнего полугода - стандартная проверка при закупе с авиты. Отзывы читать обязательно!;
- Адекватный ценник (до майнбума) за диск на вторрынке - 1-1.25 рубля/гигабайт в зависимости от наработки. Старый хлам - исключение, может стоить как шапку риса, так и последние портки;
- Хороший вариант сэкономить и не пролететь - позаглядывать в комиссионки. Как-никак репутация магазина и настоящая гарантия на 2 недели;
- Покупать только локально, при личной встрече, в том числе и по причине, указанной выше. И не жалуйся потом после получения посылки в отделении ПР что диск не читается - тебя предупреждали;
- **ОБЯЗАТЕЛЬНО** сверять серийники на диске с тем, что было показано на скриншотах и фотографиях. Само собой могут переклеить, но это скорее относится к накопителям высокой ёмкости;
- Обязательно выбить из продавана свежий смарт и _хотя бы_ график быстрого сканирования, но лучше - полный. График должен быть гладким пологим, SMART - в соответствии с пунктом "Оценка состояния по SMART" данного FAQ;
- Обязательно, повторяю, **ОБЯЗАТЕЛЬНО** после покупки проводить полный комплекс проверок, описанный выше.

### Решение проблем

1. Купил диск, а он не размечается? Если SMART накопителя в порядке, то грузишься в безопасный режим или GParted и размечаешь там.

2. Диск периодически отваливается из системы? Проверяй подключение шлейфов, перекинь диск на другой шлейф/коннектор БП, если не помогло - проверяй с другим шлейфом и БП.

*to be continued*

### Накопители для холодного хранения данных

1. **Соблюдаем [правило 3-2-1](https://habr.com/ru/company/veeam/blog/188544/).**

2. Смотря какие требования. Рекомендации:
...
- Упор на надёжность и объём - LTO. В зависимости от поколения экономия до 4х раз, но стример следует считать отдельно, стоит он немало. Выгодно начиная с объёмов архивации 100+тб. Самые выгодные поколения - LTO3~5. Есть нюансы по ПО - под 'nix используется tar, под Windows - NTBackup (выкушен с корнем в Win7+) или сторонний софт (а с ним всё плохо). Эмуляция "под флешку" появилась в LTO5 - google://LTFS. Само собой, держать подальше от магнитных полей.
- Упор на надёжность и доступность (под особо важные данные) - DVD/BD с обязательной верификацией качества записи и соблюдением условий хранения. Периодически всплывают новости о многотерабайтной оптике, впрочем, презентационными картинками сыт не будешь, а блюрей всё ещё стоит денег.
- Вариант, имеющий право на жизнь - винчестеры с авиты, как брать см. выше. Недостаток надёжности компенсировать дублированием.
